...
EXPORT_COLUMN_NAMES = {
    ...
    "tipo_estructura_grid": "Tipo_Estructura_Grid",
    "es_grid": "Es_Grid",
    "es_item_grid": "Es_Item_Grid",
    "es_grid_rm_loop": "Es_GRID_RM_LOOP",
    "orden_fila_grid": "Orden_Fila_Grid",
    "texto_fila_grid": "Texto_Fila_Grid",
    "entidad_loop": "Entidad_Loop",
    "orden_entidad_loop": "Orden_Entidad_Loop",
    "label_entidad_loop": "Label_Entidad_Loop",
    "codigo_opcion_rm": "Codigo_Opcion_RM",
    "label_opcion_rm": "Label_Opcion_RM",
    "orden_opcion_rm": "Orden_Opcion_RM",
    "codigos_columnas_grid": "Codigos_Columnas_Grid",
    "labels_columnas_grid": "Labels_Columnas_Grid",
    "tipo_escala_columnas": "Tipo_Escala_Columnas",
    "rango_esperado": "Rango_Esperado",
    "rango_observado": "Rango_Observado",
    "value_labels_compartidos": "ValueLabels_Compartidos",
    "value_label_patron": "ValueLabel_Patron",
    "patron_label_constante": "Patron_Label_Constante",
    "formato_rm": "Formato_RM",
    "valores_observados_patron": "Valores_Observados_Patron",
    "es_abierta_asociada": "Es_Abierta_Asociada",
    "base_valida_pregunta_padre": "Base_Valida_Pregunta_Padre",
    "base_valida_fila": "Base_Valida_Fila",
    "base_valida_columna": "Base_Valida_Columna",
    "regla_base_valida": "Regla_Base_Valida",
    "metrica_grid_recomendada": "Metrica_Grid_Recomendada",
    "regla_tabular_recomendada": "Regla_Tabular_Recomendada",
    "riesgo_grid": "Riesgo_Grid",
    "match_confianza": "Match_Confianza",
}
