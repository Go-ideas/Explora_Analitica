...
def normalize_metric_name(value: str) -> str:
    ...
    aliases = {
        ...
        "multirrespuesta agrupada": "Multirrespuesta agrupada",
        "% respondentes": "% respondentes",
        "porcentaje respondentes": "% respondentes",
        "menciones": "Menciones",
        "% menciones": "% menciones",
        "porcentaje menciones": "% menciones",
        "ranking opciones por entidad": "Ranking opciones por entidad",
        "ranking entidades por opción": "Ranking entidades por opción",
        "multiplicidad promedio": "Multiplicidad promedio",
        "distribución grid": "Distribución grid",
        "distribucion grid": "Distribución grid",
