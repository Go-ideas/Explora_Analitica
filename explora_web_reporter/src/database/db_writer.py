...
def _create_indexes(conn: sqlite3.Connection) -> None:
    indexes = [
        ...
        "CREATE INDEX IF NOT EXISTS idx_grid_loop_pregunta ON respuestas_grid_loop(pregunta_id)",
        "CREATE INDEX IF NOT EXISTS idx_grid_loop_pregunta_id ON respuestas_grid_loop(pregunta_id, id_respondente)",
